    ...
    internal static class AssemblyHelpers
    {
        internal static IEnumerable<string> GetAssemblyNames()
        {
            ...
            if (appCodePath != null)
            {
                ...
                if (appCode.Exists && GetAssembly(appCode.Name) != null)
                {
        ...
        internal static object GetAssemblyTypeInstance(string FullClassName)
        {
            var infos = GetAllAssembliesAndClasses().ToList();
        ...
        internal static IEnumerable<AssemblyClassInfo> GetAllAssembliesAndClasses()
        {
            var list = new List<AssemblyClassInfo>();

            var allAssemblies = GetAssemblyNames();
